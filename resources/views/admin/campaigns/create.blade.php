        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">Max 5MB (PNG, JPG, GIF) - Recommended: 1200x300px</p>
                    @error('cover_image')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="goal_text" rows="3"
                        ...
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('goal_text') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="impact_text" rows="3"
                        ...
                        class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('impact_text') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="goal_amount" value="{{ old('goal_amount') }}" step="0.01" min="0"
